...
load('./seed_file/namefile_list.mat');
load('./seed_file/short_name.mat');
load('./seed_file/label.mat');
...
for i = 1:15 % subject
    for j = 1:3 % session
        ...
        file_path = strcat('D:/EEGdata/SEED/SEED/Preprocessed_EEG/',file_pre,'.mat');
        ...
        for k = 1:15 % trial
            ...
            saveDir = strcat('D:/EEGdata/SEED/seed_save/S',num2str(i),'_',num2str(j),'_',num2str(k),'.mat');
